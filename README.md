...
[Download the ZIP from this location](https://github.com/peterboro/AwesomeBookEs6/archive/refs/heads/main.zip)

```bash
git https://github.com/peterboro/AwesomeBookEs6.git
```
...
Feel free to check the [issues page](https://github.com/peterboro/AwesomeBookEs6/issues).
